...
```{r, echo=T}
tmp_s <- summary(baseball)
print(tmp_s)
# I have given %.2f for age and height instead of %.1f since I can't for now 
# look at every possible value in the list to verify.
print("There are in total 1034 Baseball players with an average age, Weight, and Height of 28.7, 202, 73.7 respectively")
```
...
xlab('Height') +
ylab('Weight') +
labs(subtitle='Baseball players Height vs Weight')
```
